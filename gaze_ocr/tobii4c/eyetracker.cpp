...
class EyeTracker {
  static void gaze_point_callback(tobii_gaze_point_t const *gaze_point, void *user_data) {
    ...
    EyeTracker& et = *(EyeTracker*) user_data;
    et.gazeX = gaze_point->position_xy[0];
    et.gazeY = gaze_point->position_xy[1];
  }
  friend void gaze_point_callback();
